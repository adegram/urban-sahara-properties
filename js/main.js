  ...
  if (form) {
    form.addEventListener("submit", event => {
      ...
      const isConfigured =
        ...
        Object.values(entries).every(value => value && !value.includes("REPLACE"));

      if (!isConfigured) {
        setStatus("The form is ready, but Google Forms still needs to be connected in js/config.js.", "error");
        return;
      }
      ...
      form.reset();
      setStatus("Thank you. Your enquiry has been received. We'll contact you shortly.", "success");
    });
  }
})();
